...
public class Tags extends TableImpl<TagsRecord> {
	...
	private static final long serialVersionUID = -1889327626;
	...
	/**
	 * The column <code>public.tags.tid</code>.
	 */
	public final TableField<TagsRecord, Integer> TID = createField("tid", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>public.tags.tag</code>.
	 */
	public final TableField<TagsRecord, String> TAG = createField("tag", org.jooq.impl.SQLDataType.VARCHAR.length(250), this, "");
